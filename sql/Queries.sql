...
SELECT s.name, s.surname, s2.name, s3.id_of_courseroom, cr.description ,s3.week_day
...
SELECT lesson_date, s.name,  s2.name , IFNULL(  sp.was_absent, 0) as was_absent ,mark from lessons
